 ...
 */
Ext.define('BillsApp.view.Login', {
    ...
    showLoginText: function() {
        ...
        var redirectUrl = Ext.Object.toQueryString({
            ...
            client_id: BillsApp.app.facebookAppId,
            response_type: 'token'
        });
        ...
        this.setHtml([
            ...
            '<div class="fb-facepile" data-app-id="' + BillsApp.app.facebookAppId + '" data-max-rows="2" data-width="300"></div>'
        ].join(''));
